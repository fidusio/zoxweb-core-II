...
public class ProxyConnection {
    public static void main(String ...args)
    {
        try
        {
            ...
            {
		        HTTPMessageConfigInterface hcc = HTTPMessageConfig.createAndInit(args[i], null, HTTPMethod.GET, false);
		        ...
		        SharedUtil.putUnique(results, ts, rd.getStatus() + " Command: " +str+ " it took " + ts + " millis");
            }
