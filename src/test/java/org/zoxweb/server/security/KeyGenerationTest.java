		...
		try 
		{
			for (int i = 0; i < 5; i++)
			{
				...
				for(int j=0; j<2; j++)
				{
					...
					byte encrypted[] = CryptoUtil.encrypt(bobKey.getPublic(), SharedStringUtil.getBytes(json));
...
//		      "jg/3747WSsf/zBTcHihTRBdAv6OmdhV4/dD5YBfLAkLrd+mX7iE=", "\n"));
		  ...
		  System.out.println("Singnature status: " + CryptoUtil.verify(SignatureAlgo.SHA256_RSA, jwtPubKey, SharedStringUtil.getBytes(tok), sig));
