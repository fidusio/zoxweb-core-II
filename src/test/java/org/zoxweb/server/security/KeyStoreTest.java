...
public class KeyStoreTest 
{
	public static void main(String ...args)
	{
		...
		{
			int index = 0;
			KeyStoreInfoDAO ksid = GSONUtil.fromJSON(IOUtil.inputStreamToString(args[index++]), KeyStoreInfoDAO.class);
			KeyStore ks = CryptoUtil.loadKeyStore(new FileInputStream(ksid.getKeyStore()),
			 ...
			 SecretKey sk = (SecretKey) CryptoUtil.getKeyFromKeyStore(ks, ksid.getAlias(), ksid.getAliasPassword());
			 ...
			 System.out.println(SharedStringUtil.bytesToHex(ksPkcs12.getKey(ksid.getAlias(), null).getEncoded()));
