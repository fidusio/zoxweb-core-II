...
public class HTTPServerConfigTest {
  ...
  public void valueChecks() throws IOException {
    HTTPServerConfig hsc = GSONUtil.fromJSON(IOUtil.inputStreamToString(getClass().getClassLoader().getResourceAsStream(jsonConfigFile), true), HTTPServerConfig.class);
