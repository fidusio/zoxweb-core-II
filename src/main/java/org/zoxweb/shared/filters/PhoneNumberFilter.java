	...
	implements ValueFilter<String, String>
{
	...
	/**
	 * This method validates the given number.
	 * @param in
			...
			throws NullPointerException, IllegalArgumentException 
	{
		...
		{
			if (openParenthesisToken.getCount() != 1 || closeParenthesisToken.getCount() != 1 || closeParenthesisToken.getIndex() <= (openParenthesisToken.getIndex() + 1))
			{
				throw new IllegalArgumentException("Invalid number: " +  in);
			}
		}
