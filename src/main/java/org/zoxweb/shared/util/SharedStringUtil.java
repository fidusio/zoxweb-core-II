...
public final class SharedStringUtil 
{
	...
	/**
	 * This creates a constructor which cannot be used outside the class.
	 */
	...
	/**
	 * This method will return a substring to the right of the specified index if both val and token are not null, 
	 * otherwise will return empty string.
	 * @param val
	 * @param token
	 * @return
	...
	/**
	 * This method will return a substring starting at the beginning of the string and ending to the left of the specified index
	 * if both val and token are not null, otherwise will return empty string.
	 * @param val
	 * @param token
	 * @return
	...
	/**
	 * This method is used by parseString method to filter the string and return new str if str is not null.
	 * @param str
	 * @param filter
	 * @return
	 */
	...
	/**
	 * This method returns a string array based on the strings str and sep.
	 * @param str
	 * @param sep
	 * @return
	 */
...
//		if ( sep == null) sep="";
	...
	/**
	 * Convert a byte into hex format string separated by the sep char.
	 * @param sep
	 * @param array
	 * @return 
	 */
//	public static String bytesToHex(char sep, byte buffer[], int offset, int len)
//	{
...
//	}
	...
	/**
	 * 
	 * Converts a byte buffer into a hexadecimal string presentation
	 * 
	 * @param buffer
	 * @param postToken
	 * @return
	...
	/**
	 * Converts a byte buffer into a hexadecimal string presentation, based on the offset and len.
	 * @param buffer
	 * @param offset
	 * @param len
	 * @return
	...
	/**
	 * This method compresses the given string given the maximum length, separator, and separator length.
	 * @param sep
	 * @param str
	 * @param maxLength
	 * @param sepLength
